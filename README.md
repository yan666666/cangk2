# cangk2
    '我们组'准备基于'Robocup2019'规则中Restaurant部分做一个智能酒保机器人，完成在起始地点接收语音指令，前往目标地点，用语音传达出顾客的需要并且等待机械臂成功接收物品,然后自主导航回到起始地点，将物品递给客户。\<br>
>>创新点：机器人利用语音主动询问顾客需求，并与顾客交流，满足顾客需要。
本人负责大作业机械臂部分，根据2019年比赛规则的'handover'和Take and serve an order部分打算做一个与导航结合的接收物品，传递物品，放置到指定位置的机械臂。
#智能大会作业
                                                         浅谈松下焊接机器人
